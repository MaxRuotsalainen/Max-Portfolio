...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `MaxRuotsalainen`, `Max-Portfolio`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/MaxRuotsalainen/Max-Portfolio.git
   ```
...
See the [open issues](https://github.com/MaxRuotsalainen/Max-Portfolio/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/MaxRuotsalainen/Max-Portfolio](https://github.com/MaxRuotsalainen/Max-Portfolio)
